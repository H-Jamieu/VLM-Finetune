...
class GLMSFTTrainer(Trainer):

    def __init__(self, *args, **kwargs):
        super(GLMSFTTrainer, self).__init__(*args, **kwargs)
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if len(lr_mapper) > 0:
                ...
                # bias and LayerNorm weights will not be decayed
    ...
    def _save_checkpoint(self, model, trial):
        ...
        if self.args.lora_enable:
            ...
            super(GLMSFTTrainer, self)._save_checkpoint(model, trial)
